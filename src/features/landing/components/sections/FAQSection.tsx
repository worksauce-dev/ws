...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      "네, 완전히 무료로 시작할 수 있습니다. 카드 등록이나 결제 정보 입력 없이 바로 사용 가능합니다. 기본 기능은 무료로 제공되며, 추후 프리미엄 기능이 필요한 경우에만 선택적으로 유료 플랜을 이용하실 수 있습니다.",
  },
  {
    question: "테스트는 얼마나 걸리나요?",
    answer:
      "지원자가 소스테스트를 완료하는 데는 약 5-10분 정도 소요됩니다. 채용 담당자는 지원자 이메일을 추가하는 데 30초, 결과 확인은 즉시 가능합니다. 전체 프로세스가 매우 간단하고 빠릅니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "워크소스의 진단 도구는 조직심리학과 산업심리학 이론을 기반으로 개발되었습니다. 다만 테스트 결과는 채용 결정의 보조 도구로 활용하시는 것을 권장하며, 면접이나 다른 평가 방법과 함께 종합적으로 판단하시는 것이 좋습니다.",
  },
];
