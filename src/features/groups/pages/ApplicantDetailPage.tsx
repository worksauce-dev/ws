...
// Mock data - TODO: API에서 가져오거나 test_result에서 생성
...
export const ApplicantDetailPage = () => {
  ...
  // TODO: test_result에서 실제 점수 계산
  const overallScore = 92; // Mock
  const matchScore = 95; // Mock
        ...
        <div className="bg-white rounded-xl border border-neutral-200 p-8">
          <div className="flex items-start justify-between">
            ...
            <div className="flex gap-6">
              <div className="text-center">
                <div
                  className={`w-24 h-24 rounded-full ${getScoreBgColor(overallScore)} flex items-center justify-center mb-2`}
                >
                  <span
              ...
              <div className="text-center">
                <div
                  className={`w-24 h-24 rounded-full ${getScoreBgColor(matchScore)} flex items-center justify-center mb-2`}
                >
                  <span
